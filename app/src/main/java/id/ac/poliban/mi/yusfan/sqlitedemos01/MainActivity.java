package id.ac.poliban.mi.yusfan.sqlitedemos01;
...
import id.ac.poliban.mi.yusfan.sqlitedemos01.adapter.FriendAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getSupportActionBar()!=null){
            ...
            getSupportActionBar().setSubtitle("yusfan studios");
        }
